...
class AdminHandler(
    ...
    def render_page2(self, template_values):
        """Renders a page using provided template values."""
        ...
        self.response.write(
            self.get_template('config.html', []).render(template_values))
    ...
    def get_noti(self):
        ...
        template_values = {}
        template_values['page_title'] = self.format_title('Notifications')
        ...
        self.render_page2(template_values)
